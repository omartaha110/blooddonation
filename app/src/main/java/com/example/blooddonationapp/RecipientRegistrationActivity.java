    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RecipientRegistrationActivity.this, com.example.blooddonationapp.LoginActivity.class);
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                if (resultUri != null){
                                    ...
                                    Intent intent = new Intent(RecipientRegistrationActivity.this, com.example.blooddonationapp.MainActivity.class);
                                    startActivity(intent);
                                    finish();
                                    loader.dismiss();
